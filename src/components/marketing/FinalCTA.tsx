...
export function FinalCTA() {
  return (
    <Section spacing="default" className="bg-accent/[0.02]">
      <Container>
        <motion.div
          ...
          className="relative rounded-3xl overflow-hidden bg-primary px-6 py-16 sm:py-20 md:px-12 lg:px-16 text-center shadow-linko"
        >
          ...
          <div className="relative z-10 flex flex-col items-center max-w-3xl mx-auto">
            ...
            <motion.div variants={fadeUpVariant as Variants}>
              <Heading as="h2" size="display" className="text-primary-foreground mb-6">
                The future belongs to those who build it.
              </Heading>
            </motion.div>

            <motion.div variants={fadeUpVariant as Variants}>
              <Text size="lg" className="text-primary-foreground/80 mb-12 max-w-2xl mx-auto leading-relaxed" balance>
            ...
            <motion.div variants={fadeUpVariant as Variants} className="flex flex-col items-center w-full">
              <Button size="lg" variant="secondary" className="w-full sm:w-auto hover:-translate-y-0.5 transition-transform duration-200 text-lg px-10 py-6 mb-6 shadow-xl text-primary bg-background border-transparent hover:bg-background/90 hover:text-primary">
                Book a Free Trial
              </Button>
              
              <Text size="sm" weight="medium" className="text-primary-foreground/70 tracking-wide">
